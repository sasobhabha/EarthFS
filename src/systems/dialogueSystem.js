...
export class DialogueSystem {
	constructor() {
		...
		this.dialogues = [
			"Welcome, Explorer. I am Commander Shashwath Manjunath. I will be guiding your mission today.",
			"You are currently piloting a heavily modified F-15 Eaglehawk, adapted for the thin Martian atmosphere.",
			...
			"Your primary objective is to survey the Martian surface and document topographical anomalies.",
			"Good luck out there, Explorer. Commander Manjunath, out."
		];
		this.currentIndex = 0;
		this.isActive = false;
		this.isPaused = false;
